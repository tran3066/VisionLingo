...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcTakePicture.setOnClickListener((view) ->{
            ...
            mcCameraBackgroundExecutor =
                    Executors.newSingleThreadScheduledExecutor();

            mcImageCapture.takePicture(outputFileOptions,
                    mcCameraBackgroundExecutor,
                            ...
                            objectDetector.process(image).addOnSuccessListener(
                                    new OnSuccessListener<List<DetectedObject>>() {
                                        ...
                                        public void onSuccess(List<DetectedObject> detectedObjects) {
                                            ...
                                            runOnUiThread( () -> {
                                                if (mcWordFromObject != null && !mcWordFromObject.isEmpty())
                                                {
        ...
        mcTranslate.setOnClickListener(
                view -> {
                    Log.d(LOG_TAG, "Launch Translate Button");
                   // intentSend.putExtra("Picture", byteArray);
...
//                    Log.d(LOG_TAG, "Sent Text");
    ...
    void bindPreview(@NonNull ProcessCameraProvider cameraProvider) {
        ...
        Camera camera = cameraProvider.bindToLifecycle(this,
                cameraSelector, preview, mcImageCapture);
    }
}